...
public class DashboardForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sorry somthing went wrong..!");

        jLabel2.setText("Contact System Administration for support.");

        jButton1.setText("Try LogIn Again");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new DashboardForm(new Staff()).setVisible(true));
    }
