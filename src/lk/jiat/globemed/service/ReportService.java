...
/**
 * Service for generating various types of reports in the GlobeMed system
 * 
 * @author upekhansaja
 */
public class ReportService {
    ...
    public String generatePatientReport() {
        ...
        try {
            ...
            for (Patient patient : patients) {
                ...
                if (contact.length() > 29) contact = contact.substring(0, 26) + "...";
    ...
    /**
     * Generate a comprehensive staff report
     */
    public String generateStaffReport() {
        ...
        try {
            ...
            for (Staff staff : staffList) {
                ...
                if (name != null && name.length() > 29) name = name.substring(0, 26) + "...";
                
                String email = staff.getEmail();
                if (email != null && email.length() > 34) email = email.substring(0, 31) + "...";
    ...
    /**
     * Generate an appointment report
     */
        ...
        try {
            ...
            for (Appointment appointment : appointments) {
                ...
                if (appointment.getPatient() != null) {
                    ...
                    if (patientName.length() > 24) patientName = patientName.substring(0, 21) + "...";
                }
                
                String doctorName = "N/A";
                if (appointment.getDoctor() != null) {
                    doctorName = appointment.getDoctor().getName();
                    if (doctorName != null && doctorName.length() > 24) doctorName = doctorName.substring(0, 21) + "...";
                }
